  ...
  return (
    ...
    >
      <div className="h-[600vh] relative" ref={ref}>
        ...
        <div className="sticky top-0 flex h-screen gap-4 items-center overflow-hidden">
          <motion.div style={{ x }} className="flex">
            <div className="w-screen h-screen flex items-center justify-center bg-gradient-to-r from-purple-300 to bg-red-300" />
            {items.map((item) => (
              <div
                key={item.id}
              ...
              >
                <div className="flex flex-col gap-8 text-white">
                  ...
                  <p className="w-80 md:w-96 lg:w-[500px] text-xl">
                    {item.desc}
                  </p>
      ...
      <div className="w-screen h-screen flex flex-col gap-16 items-center justify-center text-center">
        <h1 className="text-6xl">Do you have a projects?</h1>
        <div className="relative">
          ...
          <Link
            href="/contact"
            className="w-16 h-16 md:w-28 md:h-28 absolute top-0 left-0 right-0 bottom-0 m-auto bg-gray-600 text-white rounded-full flex items-center justify-center cursor-pointer"
          >
            Hire Me
          </Link>
        </div>
